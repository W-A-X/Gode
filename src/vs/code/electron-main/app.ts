...
import { startGodeEngine, stopGodeEngine } from '../../workbench/contrib/gode/electron-main/godeProcessMain.js';
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		...
		Event.once(this.lifecycleMainService.onWillShutdown)(e => {
			...
			// Terminate the gode-engine rendering process.
			stopGodeEngine();
		});
		...
		// Start the gode-engine offscreen rendering process (when configured).
		startGodeEngine(this.logService);
